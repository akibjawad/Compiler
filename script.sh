...
echo '2'
flex 1405112.l		#creates the lexical analyzer or scanner named lex.yy.c

echo '3'
g++ -std=c++0x -fpermissive -w -c -o l.o lex.yy.c
...
echo '5 insert file name'	# you will need to provide proper input files with ./a.out command as instructed in assignment specification
